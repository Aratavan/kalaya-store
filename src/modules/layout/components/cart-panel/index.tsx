            ...
            <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                <div className="flex w-full space-x-2 sm:space-x-4">
                    ...
                    <div className="flex flex-col justify-between w-full pb-4">
                        <div className="flex justify-between w-full pb-2 space-x-2 mt-4">
                            <div className="space-y-1">
                                <p className="text-xxmedium font-nunito dark:text-gray-400">Groundnut Oil</p>
                                <h3 className="text-xxxmedium font-nunito font-semibold leading-snug sm:pr-8">$10</h3>
                                <p className="text-xxmedium font-nunito dark:text-gray-400">1 KG</p>
                            </div>
